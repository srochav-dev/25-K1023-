...
el detalle y la ganancia total que dejó.

Cosas que usé para que funcione:
Estructuras: para manejar los datos de los productos y los clientes.

Templates: para el ordenamiento y la búsqueda lineal (como pidió el profe en las pautas).
